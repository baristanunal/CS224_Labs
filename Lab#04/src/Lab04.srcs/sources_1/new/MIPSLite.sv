...
module new_top(input logic b1, b2, clk,
            output logic dp, memwrite,
            output logic [3:0] an,
		    output logic [6:0] c);

    // We set another clock for controlling the button's pulse.
    logic mips_clk, mips_reset;
    logic[31:0] writedata, dataadr, pc, instr, readdata;

    // Set the pulse controllers for debouncing purposes.
    pulse_controller pulse_cntrl_1(clk, b1, 1'b0, mips_clk);
    pulse_controller pulse2_cntrl_2(clk, b2, 1'b0, mips_reset);
    
     // Set the MIPS computer
    top mips_processor(mips_clk, mips_reset, writedata, dataadr, pc, instr, readdata, memwrite);
    
    // Set the control display for manipulating 7-segment display.
    display_controller display_cntrl(clk, dataadr[7:4], dataadr[3:0], pc[7:4], pc[3:0], c, dp, an);
...
//		-------		-----------
		...
		8'h48: instr = 32'h20080050;    // addi $8, $0, 80
		8'h4c: instr = 32'h20090002;    // addi $9, $0, 2
		8'h50: instr = 32'h200a0008;    // addi $10, $0, 8
		8'h54: instr = 32'h1d095021;    // sracc $10, $8, $9  # (80 >> 2) + 8 = 28
		8'h58: instr = 32'h20000000;    // addi $0, $0, 0     # jumped here by jm instr below
		8'h5c: instr = 32'h0d40000f;    // jm   15($10)
		8'h60: instr = 32'h08000018;	// j 48, so it will loop here - not executed
...
module mips (input  logic        clk, reset,
  ...
  logic        memtoreg, pcsrc, zero, alusrc, regdst, regwrite, jump, jumpmem, immsel, writemux;
  logic [2:0]  alucontrol;

  controller c (instr[31:26], instr[5:0], zero, memtoreg, memwrite, pcsrc,
                        alusrc, regdst, regwrite, jump,
                        jumpmem, immsel, writemux,
                        alucontrol);
...
module controller(input  logic[5:0] op, funct,
                  ...
                  output logic     jump,
                  output logic     jumpmem, immsel, writemux, 
   ...
   maindec md (op, memtoreg, memwrite, branch, alusrc, regdst, regwrite, 
		 jump, jumpmem, immsel, writemux, aluop);
...
module maindec (input logic[5:0] op, 
   ...
   assign {regwrite, regdst, alusrc, branch, memwrite,
                memtoreg,  aluop, jump, jumpmem, immsel, writemux} = controls;
  ...
  always_comb
    case(op)
      ...
      6'b000111: controls <= 12'b110000100001; // SRACC
      6'b000011: controls <= 12'b001000000110; // JM
...
module aludec (input    logic[5:0] funct,
  ...
  always_comb
    case(aluop)
      2'b00: alucontrol  = 3'b010;  // add  (for lw/sw/addi/jm)
...
module datapath (input  logic clk, reset, memtoreg, pcsrc, alusrc, regdst,
                 ...
                 input  logic jumpmem, immsel, writemux, 
  ...
  logic [31:0] signimm, signimmsh, srca, srcb, result, rd3;
  logic [31:0] sumr, wd3, immtype, pcjmnext;
  ...
  mux2 #(32)  pcbrmux(pcjmnext, pcbranch, pcsrc,
                      pcnextbr);
...
// register file logic
  ...
  // ALU logic
   mux2 #(32)  srcbmux (writedata, immtype, alusrc, srcb);
   alu         alu (srca, srcb, alucontrol, aluout, zero);
   
   // SRACC logic
   adder      shadd  (aluout, rd3, sumr);
   mux2 #(32) wrfmux (result, sumr, writemux, wd3);
   
   // JM logic
   mux2 #(32) immmux  (signimm, signimmsh, immsel, immtype);
   mux2 #(32) pcjmmux (pcplus4, result, jumpmem, pcjmnext);
